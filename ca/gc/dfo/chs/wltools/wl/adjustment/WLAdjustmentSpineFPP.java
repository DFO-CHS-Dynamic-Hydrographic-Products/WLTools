...
final public class WLAdjustmentSpineFPP extends WLAdjustmentSpinePP {
 ...
 /**
  ...
  public WLAdjustmentSpineFPP(/*@NotNull*/ final HashMap<String,String> argsMap) {
    ...
    final String mmi= "mWLAdjustmentSpineFPP ain constructor: ";
    ...
    // --- Now check if we have at least 31 days of data in the future for the S104 DCF8 input file.
    //     If not we stop the exec.

    // --- Tell the HDFql world to use just one thread here. 
