...
public interface IWLToolsIO {
  ...
  final static String PKG_CFG_TIDAL_DIR= PKG_CFG_MAIN_DIR + "/tidal";
  final static String PKG_CFG_TIDAL_STATIONARY_DIR= PKG_CFG_TIDAL_DIR + "/stationary:";
  final static String PKG_CFG_TIDAL_NON_STATIONARY_DIR= PKG_CFG_TIDAL_DIR + "/tidal/nonStationary";
