...
final public class writePredErrorsInOne30Format {
  ...
  static public void main (String[] args) {
   ...
   FileWriter ofile;
    ...
    final double errIncr= 0.0000575;
    ...
    for (int didx= 0; didx< dataIn.size(); didx++ ) {
      ...
      for (int vidx= 0; vidx< dList.size()-1; vidx++ ) {
       ...
       //(int)(encodeFactor*dList.get(vidx)))+";";
        ...
        encodedValuesBundleLine.append( String.format("%05d", (int)(encodeFactor*(errAcc+vidx*errIncr)))+";");
      ...
      encodedValuesBundleLine.append( String.format("%05d", (int)(encodeFactor*(errAcc+dList.size()*errIncr)) ));
